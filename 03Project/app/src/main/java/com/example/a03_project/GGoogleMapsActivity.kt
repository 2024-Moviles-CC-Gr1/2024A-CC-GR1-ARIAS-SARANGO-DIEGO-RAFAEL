...
class GGoogleMapsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        solicitarPermisos()
        iniciarLogicaMapa()
        val botonConcesionario = findViewById<Button>(R.id.btn_ir_concesionario)
        botonConcesionario.setOnClickListener {
            val concesionario = LatLng(-0.105091, -78.476049)
            val zoom = 17f
